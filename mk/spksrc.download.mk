	  ...
	  case "$(PKG_DOWNLOAD_METHOD)" in \
	    ...
	    *) \
	      ...
	      if [ -f $${localFile} ]; then \
	        ...
	        $(MSG) "  wget --no-check-certificate --secure-protocol=TLSv1_2 --timeout=30 --waitretry=0 --tries=5 -nv $${url}" ; \
	        rm -f $${localFile}.part ; \
	        wget --no-check-certificate --secure-protocol=TLSv1_2 --timeout=30 --waitretry=0 --tries=5 -nv -O $${localFile}.part -nc $${url} ; \
